        ...
        <form wire:submit.prevent='saveNewPassword' wire:ignore.self>
          <div class="form-group">
            <div class="form-group">
              ...
              <input wire:model="newPassword" type="password" class="form-control" id="new_password" placeholder="********">
              @error('newPassword')
            ...
            <div class="form-group">
              ...
              <input wire:model="coNewPassword" type="password" class="form-control" id="co_new_password" placeholder="********">
              @error('coNewPassword')
                  <span class="text-danger">{{ $message }}</span>
              @enderror
            </div>
