<div>
  ...
  <section class="breadcrumb-section set-bg mb-4" data-setbg="{{ asset('banner/banner.png') }}">{{-- --}}
    <div class="container">
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="checkout__input">
            ...
            <input type="text" placeholder="Enter your birth plece">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="checkout__input">
        ...
        <div class="col-lg-6">
          <div class="checkout__input">
            ...
            <input type="text" placeholder="Enter your national">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="checkout__input">
            <p>Raligion<span>*</span></p>
            <input type="text" placeholder="Enter your raligion">
          </div>
        </div>
