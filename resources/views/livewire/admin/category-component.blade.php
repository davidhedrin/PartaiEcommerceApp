<div>
  ...
  @if (count($allCategory) > 0)
    <div class="row row-cols-1 row-cols-md-6 g-4">
      @foreach ($allCategory as $category)
        <div class="col">
          <div class="card">
            <img class="card-img-top image-category" src="{{ asset('storage/category/'.$category->image) }}" alt="Card image cap">
            <div class="card-img-overlay px-2 py-2 d-flex justify-content-end">
              <div class="px-1">
                <button wire:click="openModalEdit({{ $category->id }})" type="button" class="btn rounded-pill btn-sm btn-primary">
                  <i class='bx bxs-edit'></i>
                </button>
              </div>
              <div>
                <button wire:click="openModalDelete({{ $category->id }})" type="button" class="btn rounded-pill btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalDelete">
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                  ...
                  <div class="button-wrapper">
                    <label for="gambar_kategori" class="btn btn-primary me-2 mb-4" tabindex="0">
                      ...
                      <input wire:model="image" type="file" id="gambar_kategori" class="account-file-input" hidden="" accept="image/png, image/jpeg">
                    </label>
                    <button wire:click="resetImageVal" type="button" class="btn btn-outline-secondary account-image-reset mb-4">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form wire:submit.prevent="">
          <div class="modal-body">
            <div class="row">
              <div class="col mb-3">
                ...
                <input wire:model="name" type="text" id="nama_kategori_edit" class="form-control" placeholder="Masukkan nama kategori">
                @error('name')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
              </div>
                ...
                <div class="d-flex align-items-start align-items-sm-center gap-4">
                  ...
                  <div class="button-wrapper">
                    <label for="gambar_kategori_edit" class="btn btn-primary me-2 mb-4" tabindex="0">
                      <span class="d-none d-sm-block">Upload</span>
                      <i class="bx bx-upload d-block d-sm-none"></i>
                      <input wire:model="newimage" type="file" id="gambar_kategori_edit" class="account-file-input" hidden="" accept="image/png, image/jpeg">
                    </label>
                    <p class="text-muted mb-0">Allowed JPG or PNG. Max size of 800K</p>
                  </div>
                  @error('newimage')
          ...
          <div class="modal-footer">
            <button wire:click='resetFormValue' type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button>
  ...
  <div wire:ignore.self class="modal fade" id="modalDelete" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button wire:click='resetFormValue' type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
