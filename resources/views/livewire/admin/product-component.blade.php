      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              <label for="regular_price" class="form-label">Harga Jual <span style="color: red">*</span></label>
            ...
            <div class="col-md-4 mb-3">
              <label for="quantity" class="form-label">Stok Produk <span style="color: red">*</span></label>
            ...
            <div class="col-md-4 mb-3">
              <label for="short_desc" class="form-label">Info</label>
            ...
            <div class="col-md-12 mb-3">
              <label for="category_id" class="form-label">Produk Unggulan</label>
